          ...
          {photoCards.map((row, index) => {
            ...
            return (
              <motion.div
                ...
                className="flex gap-5 overflow-hidden rounded-xl border border-stone bg-canvas/pure shadow-sm"
              ...
              >
                <div className="relative h-[196px] w-[140px] shrink-0 bg-canvas">
                  {row.photoUrl ? (
                    <Image alt={`${row.name} 照片 / photo`} className="object-contain" fill sizes="140px" src={row.photoUrl} />
                  ) : null}
                </div>
